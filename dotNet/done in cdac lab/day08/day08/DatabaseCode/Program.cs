...
namespace DatabaseCode
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //InsertWithStoredProcedure(obj);     // to insert data using stored procdure
        ...
        static void SelectSingleValueOnly()
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "select Name from Employees where EmpNo=5";
                //cmd.CommandText = "select count(*) from Employees";
                //cmd.CommandText = "select * from Employees where EmpNo=5";
